...
#define IMAGE_TLV_SHA               (0x11)   /* SHA384 of image hdr and body */
#elif defined(USE_SHA512)
#define IMAGE_TLV_SHA               (0x12)   /* SHA512 of image hdr and body */
#else
...
#define IMAGE_TLV_LMS               (0x100)   /* LMS of hash output */
#define IMAGE_TLV_XMSS              (0x101)   /* XMSS of hash output */
#define IMAGE_TLV_ENC_KDF_CMAC      (0x102)   /* Salt and nonce for KBKDF-CMAC key derivation (32 bytes) */
#define IMAGE_TLV_MLDSA44           (0x103)   /* ML-DSA-44 (Dilithium2) of hash output */
#define IMAGE_TLV_MLDSA65           (0x104)   /* ML-DSA-65 (Dilithium3) of hash output */
#define IMAGE_TLV_MLDSA87           (0x105)   /* ML-DSA-87 (Dilithium5) of hash output */
...
int bootutil_tlv_iter_is_prot(const struct image_tlv_iter *it, uint32_t off);
