...
#if defined (MCUBOOT_ENCRYPT_KDF_CMAC)
#include "aes_kdf.h"
#else
#include "bootutil/crypto/aes_ctr.h"
#endif /* MCUBOOT_ENCRYPT_KDF_CMAC */
...
#elif defined (MCUBOOT_ENCRYPT_KDF_CMAC)
/* KDF-CMAC hardware implementation does not need to store context here */
#else 
