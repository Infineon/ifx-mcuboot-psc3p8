...
#include "mcuboot_config/mcuboot_config.h"
...
#if defined(MCUBOOT_SHA_CUSTOM_INTERFACE)
    #include "sha_port.h"
#else
    ...
    #define BOOTUTIL_CRYPTO_SHA_BLOCK_SIZE TC_SHA256_BLOCK_SIZE
    #define BOOTUTIL_CRYPTO_SHA_DIGEST_SIZE TC_SHA256_DIGEST_SIZE
...
#endif /* MCUBOOT_SHA_CUSTOM_INTERFACE */
