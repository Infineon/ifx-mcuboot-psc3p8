 ...
 * device-db 4.100.0.9387
 * mtb-dsl-psc3m8 0.5.800.195
 *
 *******************************************************************************
...
#if !defined(PSC3M8GFS3PAHQ1)
#error "Unexpected MPN; expected DEVICE:=PSC3M8GFS3PAHQ1. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(PSC3M8GFS3PAHQ1) */
