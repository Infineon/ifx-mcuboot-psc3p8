...
const cyhal_resource_inst_t peri_0_group_3_div_8_0_obj =
{
    .type = CYHAL_RSC_CLOCK,
    .block_num = peri_0_group_3_div_8_0_HW,
    .channel_num = peri_0_group_3_div_8_0_NUM,
};
...
void init_cycfg_clocks(void)
{
    ...
    Cy_SysClk_PeriPclkSetDivider((en_clk_dst_t)PERI_0_GROUP_3_DIV_8_0_GRP_NUM, CY_SYSCLK_DIV_8_BIT, 0U, 12U);
...
{
#if defined (CY_USING_HAL)
    cyhal_hwmgr_reserve(&peri_0_group_3_div_8_0_obj);
#endif /* defined (CY_USING_HAL) */
}
