...
def main():
    ...
    if params.nonce_file is not None:
        try:
        ...
        if policy_key_path:
            ...
            try:
                aes_key_file = open(full_key_path, "rb")
            except (FileNotFoundError, OSError):
                print('\nERROR: Cannot open ', full_key_path, file=sys.stderr)
                sys.exit(Error.IO)
