...
*********************************************************************************
* \copyright
* Copyright 2019-2026, Infineon Technologies AG,
...
typedef enum
{
    CY_RBC_SUCCESS = 0UL,      /**< Operation completed successfully */
    CY_RBC_INVALID = 0xFFFFFFFFUL,  /**< Invalid operation or error occurred */
} cy_rbc_result_t;
